...
# I don't know what the anemometer height is at KBIV!!

```{r}
#ht <- 10 #station height in meters
...
d1 <- read_csv('./KBIV/KBIV_19961231_20201203.csv',skip=9,col_names=col_names,col_types=col_types,na=c("","m","M","NC"),n_max=209477) %>% select(-empty)
...
saveRDS(data,file="./KBIV/KBIV_19961231_20201203_dp.rds")
```
