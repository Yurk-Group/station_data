...
d1 <- read_csv('./KMKG/KMKG_19480101_19591231.csv',skip=9,col_names=col_names,col_types=col_types,na=c("","m","M","NC"),n_max=86135) %>% select(-empty)

d2 <- read_csv('./KMKG/KMKG_19600101_19891231.csv',skip=9,col_names=col_names,col_types=col_types,na=c("","m","M","NC"),n_max=215644) %>% select(-empty)

d3 <- read_csv('./KMKG/KMKG_19900101_20201204.csv',skip=9,col_names=col_names,col_types=col_types,na=c("","m","M","NC"),n_max=271048) %>% select(-empty)
...
saveRDS(data,file="./KMKG/KMKG_19480101_20201204_dp.rds")
```