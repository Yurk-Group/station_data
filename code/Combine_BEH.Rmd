...
The file for this station is strange. The first 1100 or so records are repeated.
...
d1 <- read_csv('./BEH/BEH_19730101_20201207.csv',skip=9+1102,col_names=col_names,col_types=col_types,na=c("","m","M","NC"),n_max=320439-1102) %>% select(-empty)
...
saveRDS(data,file="./BEH/BEH_19730101_20201207_dp.rds")
```
