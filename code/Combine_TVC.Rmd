...
d1 <- read_csv('./TVC/TVC_19490101_19591231.csv',skip=9+2376,col_names=col_names,col_types=col_types,na=c("","m","M","NC"),n_max=99519-2376) %>% select(-empty)

d2 <- read_csv('./TVC/TVC_19600101_19891231.csv',skip=9,col_names=col_names,col_types=col_types,na=c("","m","M","NC"),n_max=213786) %>% select(-empty)

d3 <- read_csv('./TVC/TVC_19900101_20201207.csv',skip=9,col_names=col_names,col_types=col_types,na=c("","m","M","NC"),n_max=270396) %>% select(-empty)
...
saveRDS(data,file="./TVC/TVC_19481201_20201207_dp.rds")
```
