...
d1 <- read_csv('./MDW/MDW_19480101_19591231.csv',skip=9,col_names=col_names,col_types=col_types,na=c("","m","M","NC"),n_max=105186) %>% select(-empty)

d2 <- read_csv('./MDW/MDW_19600101_19891231.csv',skip=9,col_names=col_names,col_types=col_types,na=c("","m","M","NC"),n_max=259730) %>% select(-empty)

d3 <- read_csv('./MDW/MDW_19900101_20201207.csv',skip=9,col_names=col_names,col_types=col_types,na=c("","m","M","NC"),n_max=269147) %>% select(-empty)
...
saveRDS(data,file="./MDW/MDW_19480101_20201207_dp.rds")
```
